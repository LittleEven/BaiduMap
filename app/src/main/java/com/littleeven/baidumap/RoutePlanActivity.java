...
public class RoutePlanActivity extends Activity implements BaiduMap.OnMapClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        start = findViewById(R.id.start_et);
        end = findViewById(R.id.end_et);
    }

    //发起路线规划搜索示例
    public void searchButtonProcess(View v) {
        String startNodeStr = start.getText().toString();
        String endNodeStr = end.getText().toString();
        // 重置浏览节点的路线数据
        route = null;
        mBtnPre.setVisibility(View.INVISIBLE);
        mBtnNext.setVisibility(View.INVISIBLE);
        ...
        PlanNode stNode = PlanNode.withCityNameAndPlaceName("兰州", startNodeStr);
        PlanNode enNode = PlanNode.withCityNameAndPlaceName("兰州", endNodeStr);
    ...
    class MyTransitDlg extends Dialog {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            setContentView(R.layout.act_transitdialog);
